            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Degree with Departments</h1>
                        <div class="text-end">
                            <button class="btn btn-primary" type="button">
                                <a href="addDepartment.php" style="text-decoration: none;color:white;">Add Departments</a>
                            </button>
                        </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">List of Degree with Departments</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class='table table-bordered' id='dataTable' width='100%' cellspacing='0'>
                                    ...
                                    while ($row = mysqli_fetch_assoc($ex)) { ?>
                                        <tr id='tr'>
                                            ...
                                            <?php $degree_name = mysqli_fetch_assoc(mysqli_query($db, "select degreename from adddegree where id='$row[degree_id]'")); ?>
                                            <td id='degree-name'><?php echo $degree_name['degreename'] ?></td>
                                            <td id='department-name'><?php echo $row['dptname'] ?></td>
                                            <td class="d-flex justify-content-around ">
                                                <a href="addDepartment.php?id=<?php echo $row['id']; ?>" class="btn btn-info btn-sm"><i class="fa-solid fa-pen" style="color: #ffffff;"></i> Edit</a>
                                                <form action="addDepartment.php" method="POST">
                                                    <a href="addDepartment.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" name="delete"><i class="fa-solid fa-trash" style="color: #ffffff;"></i> Delete</a>
                                                </form>
                                            </td>
                                        </tr>
                                    <?php } ?>
