                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="text-end">
                            <button class="btn btn-primary" type="button">
                                <a href="addcollege.php" style="text-decoration: none;color:white;">Add College</a>
                            </button>
                        </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">List of College`s</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class='table table-bordered' id='dataTable' width='100%' cellspacing='0'>
                                    ...
                                    while ($row = mysqli_fetch_assoc($ex)) { ?>
                                        <tr id='tr'>
                                            ...
                                            <td id='college-name'><?php echo $row['collegename'] ?></td>
                                            <td class="d-flex justify-content-around ">
                                                <a href="editcollege.php?id=<?php echo $row['id']; ?>" class="btn btn-info btn-sm"><i class="fa-solid fa-pen" style="color: #ffffff;"></i> Edit</a>
                                                <form action="editcollege.php" method="POST">
                                                    <a href="editcollege.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" name="delete"><i class="fa-solid fa-trash" style="color: #ffffff;"></i> Delete</a>
                                                </form>
                                            </td>
                                        </tr>
                                    <?php } ?>
