            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form method="post"
                        ...
                        <div class="input-group">
                            <input type="text" id="searchid" class="form-control bg-light border-0 small" name="search" placeholder="Search for..."
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <form method="post"
                        class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                        <div class="input-group">
                            <input type="text" id="searchInput" onkeyup="filterTable()" class="form-control bg-light border-0 small" name="search" placeholder="Search for..."
                                aria-label="Search" aria-describedby="basic-addon2">
                            <div class="input-group-append">
                                <button class="btn btn-primary" type="button">
                                    <i class="fas fa-search fa-sm"></i>
                            ...
                            <div class="table-responsive">
                                <table class='table table-bordered' id='dataTable' width='100%' cellspacing='0'>
                                    ...
                                    while ($row = mysqli_fetch_assoc($ex)) { ?>
                                        <tr id='tr'>
                                            <td id='course-id'><?php echo $row['cid'] ?></td>
                                            <td id='course-name'><?php echo $row['course_name'] ?></td>
                                            <td id='course-price'><i class='fa-solid fa-indian-rupee-sign' style='color: #000000;'></i><?php echo $row['course_fees'] ?></td>
                                            <td id='course-duration'><?php echo $row['course_duration'] ?></td>
                                            <td id='course-syllabus'><?php echo $row['course_syllabus'] ?></td>
                                            <td id='category'>
