            ...
            <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingTo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="currentpro.php">Current Projects</a>
                        <a class="collapse-item" href="Terminatepro.php">Completed projects</a>
                        <!-- <a class="collapse-item" href="Projects.php">Projects</a> -->
                    </div>
                </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Advance Payments</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td>Internship</td>
                                            <td>Muthulakshmi E</td>
                                            <td>6369348382</td>
                                            <td>muthu@gmail.com</td>
                                            <td>4500</td>
                                            <td>Sankarapandipuram Street,Rajapalayam.</td>
                                            <td>12.08.2024</td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            ...
                                            <td>7900</td>
                                            <td>bala nagar,East Street,sivakasi</td>
                                            <td>27.03.2024</td>
                                        </tr>
                                        <tr>
                                            <td>3</td>
                                            ...
                                            <td>12000</td>
                                            <td>Thevar nagar,Srivilliputhur.</td>
                                            <td>12.08.2024</td>
                                        </tr>
